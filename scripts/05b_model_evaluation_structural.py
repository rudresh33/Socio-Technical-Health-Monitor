...
# --- ISA III: MODEL B — Communication + Structural Features ---
...
print("=" * 60)
print(f"ISA III: MODEL B — COMMUNICATION + STRUCTURAL FEATURES")
...
print("=" * 60)
print(f"Feature Set for Model B: {all_features}")